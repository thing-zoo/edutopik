...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/screen_brightness/screen_brightness.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/volume_control/volume_control.framework"
